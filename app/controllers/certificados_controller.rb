class CertificadosController < ApplicationController
  ...
  private
    ...
    def certificado_params
      params.require(:certificado).permit(:id_certificado, :nro_certificado, :rubro, :tratamiento, :otro_tratamiento, :vectores_tratados, :otros_vectores, :superficie_tratada, :veneno_clase, :droga_usada, :otra_droga_usada, :fecha_aplicacion, :fecha_vencimiento, :hora_aplicacion, :proximo_tratamiento, :estado, :importe, :id_cliente, :cliente_id)
    end
end
