...
class TecnicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tecnico" do
    assert_difference('Tecnico.count') do
      post tecnicos_url, params: { tecnico: { apellido: @tecnico.apellido, dni: @tecnico.dni, domicilio: @tecnico.domicilio, nombre: @tecnico.nombre, telefono: @tecnico.telefono } }
    end
  ...
  test "should update tecnico" do
    patch tecnico_url(@tecnico), params: { tecnico: { apellido: @tecnico.apellido, dni: @tecnico.dni, domicilio: @tecnico.domicilio, nombre: @tecnico.nombre, telefono: @tecnico.telefono } }
